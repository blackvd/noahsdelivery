...
const DeliveryInProgressScreen = ({ navigation, route }) => {
  ...
  const handleNavigate = () => {
    ...
    const url = Platform.select({
      ios: `maps:0,0?q=${dropoffCoords.latitude},${dropoffCoords.longitude}`,
      android: `geo:0,0?q=${dropoffCoords.latitude},${dropoffCoords.longitude}(${label})`,
    });
    Linking.openURL(url);
  };
  ...
  const handleTakePhoto = async () => {
    ...
    if (!result.canceled) {
      ...
      Alert.alert('Photo capturée', 'La photo de livraison a été prise avec succès.');
    }
  };
  ...
  const handleGetSignature = () => {
    ...
    Alert.alert('Signature obtenue', 'La signature du destinataire a été enregistrée.');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Route Line */}
        <Polyline
          coordinates={[pickupCoords, driverCoords, dropoffCoords]}
          strokeColor="#ef4444"
          strokeWidth={3}
          ...
          >
            ...
            <View style={styles.currentStepCard}>
              ...
              <View style={styles.stepInfo}>
                ...
                <Text style={styles.stepTitle}>{deliverySteps[currentStep].label}</Text>
              </View>
            </View>
              ...
              <View style={styles.customerHeader}>
                ...
                <View style={styles.customerInfo}>
                  ...
                  <View style={styles.customerRating}>
                    ...
                    <Text style={styles.customerRatingText}>{customerInfo.rating}</Text>
                  </View>
                </View>
                <TouchableOpacity
            ...
            {currentStep >= 2 && (
              ...
              >
                ...
                <Text style={styles.returnButtonText}>Signaler un retour de colis</Text>
              </TouchableOpacity>
            )}
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <Text style={styles.modalSubtitle}>
              Veuillez prendre une photo du colis et obtenir la signature du destinataire
            </Text>
            ...
            <View style={styles.modalActions}>
              ...
              >
                ...
                <View style={styles.modalActionText}>
                  <Text style={styles.modalActionTitle}>Obtenir la signature</Text>
                  <Text style={styles.modalActionSubtitle}>
                    {hasSignature ? 'Signature obtenue' : 'Signature du destinataire'}
                  </Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
              </TouchableOpacity>
            ...
            >
                ...
                {returnReasons.map((reason) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      selectedReturnReason === reason.id && styles.returnReasonCardSelected,
                    ]}
                  ...
                  >
                    <View style={[
                      ...
                      selectedReturnReason === reason.id && styles.returnReasonIconContainerSelected,
                    ]}>
                      <Ionicons
                        name={reason.icon}
                        size={24}
                        color={selectedReturnReason === reason.id ? '#f59e0b' : '#6b7280'}
                      />
                    </View>
                    <View style={styles.returnReasonContent}>
                      <Text style={[
                        styles.returnReasonTitle,
                        selectedReturnReason === reason.id && styles.returnReasonTitleSelected,
                      ]}>
                        {reason.title}
                      </Text>
              ...
              {selectedReturnReason === 5 && (
                <View style={styles.customReasonContainer}>
                  <Text style={styles.customReasonLabel}>Précisez la raison</Text>
                  <TextInput
              ...
              >
                ...
                <Text style={[
                  ...
                  {returnPhoto ? 'Photo capturée' : 'Prendre une photo du colis'}
                </Text>
              </TouchableOpacity>
              ...
              <View style={styles.returnModalButtons}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={styles.returnModalCancelButtonText}>Annuler</Text>
                </TouchableOpacity>

                <TouchableOpacity
                  style={[
                    styles.returnModalConfirmButton,
                    (!selectedReturnReason || !returnPhoto) && styles.returnModalConfirmButtonDisabled,
                  ]}
                  onPress={handleConfirmReturn}
                  disabled={!selectedReturnReason || !returnPhoto}
                  activeOpacity={0.7}
                >
                  <Text style={styles.returnModalConfirmButtonText}>Confirmer le retour</Text>
                </TouchableOpacity>
              </View>
            </ScrollView>
          </Animated.View>
